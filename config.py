...
--change-title @AniHorizon --change-video-title @AniHorizon --change-audio-title @AniHorizon --change-subtitle-title @AniHorizon --change-author @AniHorizon

📥 Fᴏʀ Hᴇʟᴘ Cᴏɴᴛ. @Momo_Ayase_bot """

Ani_PROGRESS = """<b>

╭━━━━❰Ani PROCESSING...❱━➣ ┣⪼ 🗃️ ꜱɪᴢᴇ: {1} | {2} ┣⪼ ⏳️ ᴅᴏɴᴇ : {0}% ┣⪼ 🚀 ꜱᴩᴇᴇᴅ: {3}/s ┣⪼ ⏰️ ᴇᴛᴀ: {4} ╰━━━━━━━━━━━━━━━➣ </b>"""
